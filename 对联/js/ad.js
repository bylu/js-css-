...
function ad_left(){
    var html;
    html = '<div id="ad_left" style="position:absolute;width:125px;height:323px;z-index:10001"><a style="position:absolute;margin-left:10px;" href="javascript:void(0);" onclick="document.getElementById(\'ad_left\').style.display=\'none\'"><span style="position:absolute;z-index:8888;width:50px;height:20px;left:90px;padding-top:5px;"></span></a><a href="http://game.789game.com/world" target="_blank"><img src="images/gril.jpg" width="125" height="323" /></a></div>';
    dom.insertHtml(html);position.floatLeftCenter('ad_left');
}
function ad_right(){
    var html;
    html = '<div id="ad_right" style="position:absolute;width:125px;height:323px;z-index:10001"><a style="position:absolute;margin-right:10;" href="javascript:void(0);" onclick="document.getElementById(\'ad_right\').style.display=\'none\'"><span style="position:absolute;z-index:8888;width:50px;height:20px;left:100px;padding-top:5px;"></span></a><a href="http://game.789game.com/world" target="_blank"><img src="images/playworld.jpg" width="125" height="323" /></a></div>';
